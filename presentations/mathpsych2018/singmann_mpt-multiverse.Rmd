...
- Multiverse analysis of 6-point ROCs with 2HTM:
  ...
  2. Surprisingly strong agreement in terms of point estimates (~ .9)
...
- **Note**: Results do not suggest that hierarchical models are not necessary. - Aggregation artifacts can occur:
  - Learning & practice (e.g., Estes, 1956, Psych. Bull.; Evans, Brown, Mewhort, & Heathcote, in press, Psych. Review)
  - ROCs (Trippas, Kellen, Singmann, et al., in press, PB&R)
