...
gof_a$dataset <- factor(gof_a$dataset, levels = c("Dube_2012-P.csv", "Dube_2012-W.csv", "Heathcote_2006_e1.csv", "Heathcote_2006_e2.csv", "Jaeger_2012.csv", "Koen_2013_immediate.csv"), 
...
params$dataset <- factor(params$dataset, levels = c("Jang_2009.csv", "Koen_2010_pure.csv", "Koen_2011.csv", "Koen-2013_full.csv", "Pratte_2010.csv", "Smith_2004.csv", "Dube_2012-P.csv", "Dube_2012-W.csv", "Heathcote_2006_e1.csv", "Heathcote_2006_e2.csv", "Jaeger_2012.csv", "Koen_2013_immediate.csv"), 
                        labels = c("Jang9", "Koen10", "Koen11","Koen13F","Pratte10","Smith4", "Dube12P", "Dube12W","Heath6-1","Heath6-2","Jae12","Koen13I"))
