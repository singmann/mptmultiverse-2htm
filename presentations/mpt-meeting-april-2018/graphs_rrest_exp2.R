...
ggplot(core, aes(y = est, x = inter)) +
  ...
  labs(x='Model',y='Estimate', title='Estimates of Core Parameters')+
  theme_bw()+
...
core_w <- filter(core, condition %in% c('Strong wording')) 

ggplot(core_w, aes(y = est, x = inter)) +
  geom_errorbar(aes(ymin = est-se, ymax = est+se), position = dd, 
                width = 0.6)+
  facet_grid(bias ~cp) +
...
ggplot(core_bn, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  labs(x='Model',y='Estimate', title='Core Parameters for "biased new" condition')+
  theme_bw()+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  theme(text=element_text(size = 24))+
  coord_flip()
...
ggplot(core_bo, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  labs(x='Model',y='Estimate', title='Core Parameters for "biased old" condition')+
  theme_bw()+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  theme(text=element_text(size = 24))+
  coord_flip()
...
ggplot(params_q, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  scale_shape_manual(values=shapes) +
  labs(x='Model',y='Estimate', title='Estimates of Q Parameters')+
  theme_bw()+
  theme(text=element_text(size = 24))+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  coord_flip()
...
q_wording <- filter(params_q, condition %in% c('Weak wording'))

ggplot(q_wording, aes(y = est, x = inter)) +
  facet_grid(bias ~pq) +
  geom_errorbar(aes(ymin = est-se, ymax = est+se), position = dd, 
                width = 0.6)+
  geom_point(position = dd, size = 3.5) +  
...
q_word1 <- filter(params_q, condition %in% c('Strong wording'))

ggplot(q_word1, aes(y = est, x = inter)) +
  facet_grid(bias ~pq) +
  geom_errorbar(aes(ymin = est-se, ymax = est+se), position = dd, 
                width = 0.6)+
  geom_point(position = dd, size = 3.5) +  
...
ggplot(q_bn, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  labs(x='Model',y='Estimate', title='Q Parameters for "biased new" condition')+
  theme_bw()+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  theme(text=element_text(size = 24))+
  coord_flip()
...
ggplot(q_bo, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  labs(x='Model',y='Estimate', title='Q Parameters for "biased old" condition')+
  theme_bw()+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  theme(text=element_text(size = 24))+
  coord_flip()
...
ggplot(params_r, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) +
  scale_shape_manual(values=shapes) +
  labs(x='Model',y='Estimate', title='Estimates of R Parameters')+
  theme_bw()+
  theme(text=element_text(size = 24))+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  coord_flip()
...
ggplot(r_bn, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  labs(x='Model',y='Estimate', title='R Parameters for "biased new" condition')+
  theme_bw()+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  theme(text=element_text(size = 24))+
  coord_flip()
...
ggplot(r_bo, aes(y = est, x = inter)) +
  ...
  scale_y_continuous(breaks=seq(0,1,by=.5),limits=c(0,1), 
                     labels = c("0", "0.5", "1")) + 
  labs(x='Model',y='Estimate', title='R Parameters for "biased old" condition')+
  theme_bw()+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  theme(text=element_text(size = 24))+
  coord_flip()
...
ggplot(core, aes(y = est_diff, x = inter)) +
  ...
  labs(x='Model',y='Estimate', title='Parameter Differences across conditions')+
  theme(text=element_text(size = 24))+
  theme(plot.title=element_text(face = 'bold',size=24, hjust = 0.5))+
  coord_flip()
