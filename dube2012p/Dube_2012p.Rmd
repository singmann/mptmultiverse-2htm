...
Frequentist approach with no pooling (asymptotic.no.MPTinR) had 0.444 as proportion of participants with non-identified parameters.
Frequentist approach with complete pooling (asymptotic.complete.MPTinR) had no convergence problems.  

Bayesian approach with no pooling (simple.no.TreeBUGS) had 5 parameters with Rhat > 1.05 and with complete pooling (simple.complete.TreeBUGS) converged well, all Rhat < 1.05.  
...
Frequentist approach with no pooling (asymptotic.no.MPTinR) had 0.778 as proportion of participants with non-identified parameters.
Frequentist approach with complete pooling (asymptotic.complete.MPTinR) had some convergence problems:  
rank.fischer = 4 (aggregated), 5 (individual), n.parameters = 10, convergence = 0.  
...
Frequentist approach with no pooling (asymptotic.no.MPTinR) had 0.481 as proportion of participants with non-identified parameters.
Frequentist approach with complete pooling (asymptotic.complete.MPTinR) had no convergence problems.  

Bayesian approach with no pooling (simple.no.TreeBUGS) had 4 parameters with Rhat > 1.05 and with complete pooling (simple.complete.TreeBUGS) had 4 parameters with Rhat > 1.05 as well. 
Bayesian approach with partial pooling (trait.partial.Treebugs and trait_uncorrelated.partial.TreeBUGS) converged well, all Rhat < 1.05. 
