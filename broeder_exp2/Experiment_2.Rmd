...
gg_est_3 <- unnest(results3, est_group) %>%
  ggplot(aes(y = est, x = parameter, 
                          col=interaction(method, pooling,package),
                          shape=interaction(method, pooling,package))) +
   facet_wrap(~condition, ncol = 1) +
...
parameters_bn <- filter(par_est, parameter %in% c("Do_bn", "Dn_bn", "g_bn","q_1_bn", "q_2_bn","q_3_bn","q_6_bn","q_7_bn","q_8_bn","r_1_bn","r_2_bn","r_3_bn",'r_6_bn',"r_7_bn","r_8_bn"))
shapes <- c(16, 18, 15, 1, 0, 8, 11, 12)
dd <- position_dodge(w = .75)
...
```
```{r, echo = FALSE, warning=FALSE, fig.width=9.5, fig.height=8}
parameters_bo <- filter(par_est, parameter %in% c("Do_bo", "Dn_bo", "g_bo","q_1_bo", "q_2_bo","q_3_bo","q_6_bo","q_7_bo","q_8_bo","r_1_bo","r_2_bo","r_3_bo",'r_6_bo',"r_7_bo","r_8_bo"))
