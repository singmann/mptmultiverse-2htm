...
Bayesian approach with complete pooling (simple.complete.TreeBUGS) converged well, all Rhat < 1.05.  
Bayesian approach with partial pooling had 89 parameters with Rhat > 1.05 but uncorrelated (trait_uncorrelated.partial.TreeBUGS) had 7 parameters with Rhat > 1.05.  
